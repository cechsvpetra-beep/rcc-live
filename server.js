...
id:teamId,
name:teams[teamId]?teams[teamId].name:"Tím "+teamId,
sector:teams[teamId]?teams[teamId].sector:"-",
peg:teams[teamId]?teams[teamId].peg:"-",
total:0,
count:0,
biggest:0
...
stats[teamId].total+=Number(c.weight)
stats[teamId].count++

if(Number(c.weight)>stats[teamId].biggest){

stats[teamId].biggest=Number(c.weight)
...
weight:c.weight,
team:teams[c.team]?teams[c.team].name:"Tím "+c.team
